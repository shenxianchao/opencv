...
public class NativeCameraGlView extends CameraBridgeGlSurface {

    public static final String TAG = "NativeCameraGlView";
    private boolean mStopThread;
    private Thread mThread;
    private VideoCapture mCamera;


    public NativeCameraGlView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
